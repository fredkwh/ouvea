...
export default function About() {
  return (
    <div className="p-8 max-w-3xl mx-auto text-gray-800 leading-relaxed">
      ...
      <p className="mb-4">
        Derrière ce projet, un passionné de nutrition, de musculation et de bien-être, qui croit que
        bâtir un corps esthétique et sain passe avant tout par une alimentation consciente,
        riche en nutriments, sans superflu.
      </p>

      <p className="mb-4">
        Nos smoothie bowls sont faits maison, livrés dans des lieux soigneusement choisis comme
